...
class Common
{
    companion object
    {
        ...
        const val API_PASSWORD_CHANGE_NEXT : String         = DEVELOP_BASE_API + "users/password/next"
        const val API_PASSWORD_CHANGE_KEEP : String         = DEVELOP_BASE_API + "users/password/keep"
        ...
        const val API_STUDENT_HOMEWORK : String             = DEVELOP_BASE_API + "homeworks/student"
        const val API_TEACHER_HOMEWORK : String             = DEVELOP_BASE_API + "homeworks/teacher"
