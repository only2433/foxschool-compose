...
class FlashCardStudyDataFragment : Fragment()
{
    ...
    {
        _Item1FrontStatusText.typeface = Font.getInstance(mContext).getRobotoRegular()
        _Item1BackStatusText.typeface = Font.getInstance(mContext).getRobotoRegular()
        _Item1WordTitleText.typeface = Font.getInstance(mContext).getRobotoBold()
        _Item1WordExampleText.typeface = Font.getInstance(mContext).getRobotoRegular()
        _Item1MeaningTitleText.typeface = Font.getInstance(mContext).getRobotoBold()
        _Item2FrontStatusText.typeface = Font.getInstance(mContext).getRobotoRegular()
        _Item2BackStatusText.typeface = Font.getInstance(mContext).getRobotoRegular()
        _Item2WordTitleText.typeface = Font.getInstance(mContext).getRobotoBold()
        _Item2WordExampleText.typeface = Font.getInstance(mContext).getRobotoRegular()
        _Item2MeaningTitleText.typeface = Font.getInstance(mContext).getRobotoBold()
    }
