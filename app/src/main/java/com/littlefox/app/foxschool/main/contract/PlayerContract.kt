...
class PlayerContract
{
    interface View : BaseContract.View
    {
        ...
        fun showPlayerStartView()
        fun showPlayerEndView()
        fun settingPlayerEndView(isEbookAvailable : Boolean, isQuizAvailable : Boolean, isVocabularyAvailable : Boolean, isFlashcardAvailable : Boolean, isStarwordsAvailable : Boolean, isCrosswordAvailable : Boolean, isTranslateAvailable : Boolean, isNextButtonVisible : Boolean)
