...
object Feature {
     ...
     * 최저 해상도 이하인지의 여부
     */
    var IS_MINIMUM_DISPLAY_SIZE = false

    /**
     * 특정 태블릿 비율이 16:9 가 아닌 정상적이지 않은 4:3 비율의 태블릿을 지원하기 위해 사용.
     */
    var IS_4_3_SUPPORT_TABLET_RADIO_DISPLAY = false

    /**
     * 유료사용자 인지 무료 사용자인지 구분하기 위해 사용
     */
    var IS_FREE_USER = true

    /**
     * 기간이 종료된 회원 인지 여부
     */
    var IS_REMAIN_DAY_END_USER = false

    /**
     * Webview 디버깅 관련 여부
     */
    const val IS_WEBVIEW_DEBUGING = false
